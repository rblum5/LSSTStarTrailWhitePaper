...
\author{David Thomas, Steven Kahn, Federica Bianco, Željko Ivezić, Claudia M. Raiteri, \\Andrea Possenti, John Peterson, Colin Burke, Robert Blum, George Jacoby, \\Steve Howell}
\date{May 2018}
...
#RN should not be multiplied by Area.
...
# 15 arcsec per sec = 0.25 arcmin per second. For 0.2 arcsec pixels this is 75 pixels per second
...
#The SNR is not really proportional to 1/S^-1/2 since there are constants in there. Better to just say is goes down w S. Unless you show S >> R^2
